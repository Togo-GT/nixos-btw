...
in
{
  ...
  hardware.nvidia = {
    ...
    # Disabled due to conflict with prime.sync.enable
    ...
    prime = {
      sync.enable = true;
      # Explicitly disable offload to avoid conflict with sync mode
  ...
  hardware.graphics = {
    ...
    extraPackages = with pkgs; [
      libva-vdpau-driver  # VA-API implementation using VDPAU - KORREKT NAVN
  ...
  # ===========================================================================
  # X11 Window System with NVIDIA drivers
  # -------------------------------------
  services.xserver = {
    enable = true;
    # Specify the video drivers for NVIDIA graphics
    videoDrivers = [ "nvidia" ];
  };
  ...
  # Git Configuration
  # -----------------
  # Global Git configuration with user information and default settings
  programs.git = {
    enable = true;
    config = {
      user.name = "Togo-GT";
  ...
  # -----------------------
  # Enables SSH agent for managing SSH keys and passphrases
  ...
  environment.systemPackages = with pkgs; [
    ...
    # Language Servers
    nodePackages.bash-language-server  # Bash language server for editor support
    ...
    wineWowPackages.stable  # Nyere Windows compatibility layer
    winetricks  # GUI for Wine configuration and Windows component installation
    ...
    mesa-demos     # OpenGL information (includes glxinfo) - KORREKT NAVN
